...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        Document userDoc = new Document("_id",username).append("password",passwordHash);// XXX HOME WORK HERE
        ...
        if (email != null && !email.equals("")) {
            userDoc.append("email",email);// XXX HOME WORK HERE
            // if there is an email address specified, add it to the document too.
        }

        try {
            usersCollection.insertOne(userDoc);// XXX HOME WORK HERE
    ...
    public Document validateLogin(String username, String password) {
        ...
        user = usersCollection.find(new Document("_id",username)).first();// XXX HOME WORK HERE
        if (user == null) {
